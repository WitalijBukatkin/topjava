    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="float-right">
                <button type="button" class="btn btn-primary" onclick="$('#filter').modal()">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><spring:message code="meal.filter"/></h4>
                ...
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="dateTime" name="dateTime"
                               value="${meal.dateTime}" placeholder="<spring:message code="meal.dateTime"/>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="calories" name="calories"
                               value="${meal.calories}" placeholder="<spring:message code="meal.calories"/>" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
