    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            default:
                ...
                LocalDate startDate = DateTimeUtil.parseLocalDate(request.getParameter("startDate"), DateTimeUtil.DATE_MIN);
                LocalDate endDate = DateTimeUtil.parseLocalDate(request.getParameter("endDate"), DateTimeUtil.DATE_MAX);
